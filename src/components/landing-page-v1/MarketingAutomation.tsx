...
const MarketingAutomation = ({ openModal }: Props) => {
  return (
    <div className="min-h-screen bg-[#f5f7fb] flex items-center justify-center p-4 -mt-8">
      <section className="w-full max-w-6xl px-6 py-10 md:px-10 lg:px-12 lg:py-12">
        <div className="flex flex-col gap-10 lg:gap-12">
          ...
          <div className="flex flex-col gap-8 lg:flex-row lg:items-start">
            ...
            <div className="space-y-8 lg:w-[40%]">
              ...
              <div className="space-y-4">
                <h2 className="text-3xl font-bold leading-tight text-[#111827] md:text-4xl sm:text-nowrap">
                  Marketing Automation
                </h2>
                <p className="max-w-md text-[24px] leading-relaxed text-[#111827]">
                  Automate followups & build timelines.
                </p>
              </div>
            </div>
            ...
            <div className="sm:hidden lg:w-[40%] md:-mt-24">
              <div className="relative max-w-md">
                <div className="overflow-hidden rounded-3xl">
                  <Image
                    src="/maglo-crm-v3/marketing-automation-1.jpg" // your image
              ...
              <div className="grid gap-6 md:grid-cols-2">
                ...
                <article className="flex flex-col rounded-3xl bg-[#e5f8f1] p-6 shadow-[0_0_0_1px_rgba(209,213,219,0.7)]">
                  ...
                  <p className="mb-3 text-sm leading-relaxed text-[#4b5563]">
                    Streamlines routine tasks, freeing up time for strategic
                    activities and ensuring consistency in customer
                    communication.
                  </p>
                ...
                <article className="flex flex-col rounded-3xl bg-[#e5f8f1] p-6 shadow-[0_0_0_1px_rgba(209,213,219,0.7)]">
                  ...
                  <h3 className="mb-2 text-lg font-semibold text-[#111827]">
                    Pre-Designed Workflows And Templates
                  </h3>
                  <p className="text-sm leading-relaxed text-[#4b5563]">
                    Accelerates processes with ready-to-use workflows and
                    templates, enhancing efficiency and reducing manual effort.
                  </p>
                </article>
              </div>
            </div>
          ...
          <div className="flex flex-col gap-8 lg:flex-row lg:items-start">
            {/* Left: IMAGE */}
            <div className="hidden md:block lg:w-[40%] md:-mt-20">
              <div className="relative max-w-md">
            ...
            <div className="lg:w-[60%] flex flex-col gap-6">
              <div className="grid gap-6 md:grid-cols-2">
                ...
                <article className="flex flex-col rounded-3xl bg-[#e5f8f1] p-6 shadow-[0_0_0_1px_rgba(209,213,219,0.7)]">
                  ...
                  <p className="mb-3 text-sm leading-relaxed text-[#4b5563]">
                    Allows sales teams to concentrate on high-value activities
                    by automating administrative tasks, driving productivity and
                    sales growth.
                  </p>
                  {/* <button className="mt-auto text-sm font-semibold text-[#0f7ae5] hover:underline">
                    Universal Forms
                ...
                <article className="flex flex-col rounded-3xl bg-[#e5f8f1] p-6 shadow-[0_0_0_1px_rgba(209,213,219,0.7)]">
                  ...
                  <p className="text-sm leading-relaxed text-[#4b5563]">
                    Minimizes human error and expedites task completion through
                    smart automation, improving overall operational efficiency.
                  </p>
                </article>
              </div>
            </div>
