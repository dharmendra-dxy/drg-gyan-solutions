...
const LeadManagement = ({ openModal }: Props) => {
  return (
            ...
            <div className="space-y-8 lg:w-[40%]">
              ...
              <div className="space-y-4">
                ...
                <p className="max-w-md text-[24px] leading-relaxed text-[#111827]">
                  Streamline your customers data. Easily upsell & manage them.
                </p>
              </div>
            </div>
            ...
            <div className="sm:hidden lg:w-[40%] md:-mt-24">
              <div className="relative max-w-md">
                <div className="overflow-hidden rounded-3xl">
                  <Image
                    src="/maglo-crm-v3/crm-contact-scaled.jpg" // your image
              ...
              <div className="grid gap-6 md:grid-cols-2">
                ...
                <article className="flex flex-col rounded-3xl bg-[#eef6fd] p-6 shadow-[0_0_0_1px_rgba(209,213,219,0.7)]">
                  ...
                  <p className="mb-3 text-sm leading-relaxed text-[#4b5563]">
                    Centralises all customer data for tailored interactions,
                ...
                <article className="flex flex-col rounded-3xl bg-[#eef6fd] p-6 shadow-[0_0_0_1px_rgba(209,213,219,0.7)]">
                  ...
                  <p className="text-sm leading-relaxed text-[#4b5563]">
                    Consolidates customer history and preferences, enabling
                    consistent and personalized experiences across all
                    touchpoints.
                  </p>
                </article>
              </div>
            ...
            <div className="lg:w-[60%] flex flex-col gap-6">
              <div className="grid gap-6 md:grid-cols-2">
                ...
                <article className="flex flex-col rounded-3xl bg-[#eef6fd] p-6 shadow-[0_0_0_1px_rgba(209,213,219,0.7)]">
                  ...
                  <p className="mb-3 text-sm leading-relaxed text-[#4b5563]">
                    Automates notifications for key dates, boosting customer
                    engagement and retention through personalized outreach.
                  </p>
                  {/* <button className="mt-auto text-sm font-semibold text-[#0f7ae5] hover:underline">
                    Universal Forms
                  </button> */}
                ...
                <article className="flex flex-col rounded-3xl bg-[#eef6fd] p-6 shadow-[0_0_0_1px_rgba(209,213,219,0.7)]">
                  ...
                  <p className="text-sm leading-relaxed text-[#4b5563]">
                    Speeds up issue resolution and inquiry handling, leading to
                    higher customer satisfaction and positive brand perception.
                  </p>
                </article>
              </div>
            </div>
