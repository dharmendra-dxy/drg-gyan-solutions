      ...
      <div className="bg-gradient-to-r from-emerald-700 to-emerald-800 text-white py-16 px-6">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-xl text-blue-100 max-w-3xl mx-auto">
            ...
            masterpiece? Our expert team is here to guide you every step of the
            way.
          </p>
        </div>
      </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <div className="mb-6">
              ...
              <p className="text-gray-600">
                ...
                proofreading, and academic mentoring - helping you learn, grow,
                and achieve academic excellence with integrity.
              </p>
